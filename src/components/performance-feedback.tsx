    ...
    <Card className="glass-card">
      <CardContent className="p-5">
        ...
        <div className="flex flex-wrap items-end gap-2 mb-2">
          ...
          <label className="flex flex-col gap-1">
            ...
            <select
              ...
              title={en ? "Opening structure used in this video" : "这支视频使用的开场结构"}
              className="h-9 rounded-md border border-input bg-background px-2 text-sm"
            >
        ...
        <p className="text-[11px] text-muted-foreground mb-4">
          {en ? "Views is required. Script style is recorded automatically." : "播放量为必填项；脚本风格会自动记录。"}
        </p>
        ...
        {insights.length > 0 && (
          <div className="border-t border-border/50 pt-3">
            <p className="text-xs font-medium mb-2">
              {en ? "Style performance across projects" : "不同脚本风格的表现"}
            </p>
        ...
        {hookInsights.length > 0 && (
          <div className="border-t border-border/50 pt-3 mt-3">
            <p className="text-xs font-medium mb-2">
              {en ? "Opening performance across projects" : "不同开场方式的表现"}
            </p>
            <div className="space-y-1.5">
