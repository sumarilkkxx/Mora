 ...
 *
 * - Custom models: users can attach any model id on an existing platform (Replicate / Volcengine / Alibaba…).
...
export interface CustomModel {
  /** Locally unique id */
  id: string;
  /** Owning platform identifier (matches the key in settings.providers, e.g. "replicate") */
  provider: string;
