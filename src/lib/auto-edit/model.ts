...
export const TOOL_PARAMETERS: Record<ToolName, Record<string, unknown>> = {
  ...
  update_edit_settings: { type: "object", additionalProperties: false, properties: { target: { type: "integer", enum: [15, 20, 30] }, audio: { type: "string", enum: ["original", "voiceover", "muted"] }, aspect: { type: "string", enum: ["9:16", "16:9", "1:1"] }, style: { type: "string", enum: ["auto", "concise", "highlights", "story"] }, captions: { type: "boolean" } } },
