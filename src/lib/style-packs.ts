 ...
 *
 * Packaged video presets make reusable editing know-how (caption looks, pacing,
 * BGM choices) the community currency; this is Mora's novice-safe take on
 * importing a style pack: it is pure JSON data — no code, no shell,
...
export const STYLE_PACK_FORMAT = "mora-style-pack@1";
...
/**
 * Built-in packs: distilled from the category templates that drive Mora's
