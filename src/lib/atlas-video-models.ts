...
export const ATLAS_VIDEO_FAMILIES: readonly AtlasVideoFamilySpec[] = [
  ...
  { id: "bytedance/seedance-2.5", name: "Seedance 2.5", durations: DURATIONS_2_5, resolutions: ["480p", "720p", "1080p"], ratios: RATIOS, maxReferenceImages: 30, maxReferenceVideos: 10, maxReferenceAudios: 10, pricePerSecond: 0.134, requestProfile: "seedance" },
