...
const shotTypeLabels: Record<Shot["type"], { key: string; color: string }> = {
  ...
  social_proof: { key: "shotTypeSocialProof", color: "bg-sky-500/15 text-sky-500" },
        ...
        <div className="mb-6 flex flex-wrap items-center gap-2 rounded-xl border border-border/50 bg-muted/10 px-3 py-2.5">
          ...
          {videoModelTarget && (
            <button
              ...
              className={`flex items-center gap-1.5 rounded-full border px-3 h-8 text-xs font-medium transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                autoMotion
          ...
          <>
            ...
            <div className="mb-6">
              <div className="h-2 bg-muted/30 rounded-full overflow-hidden">
                <div
                  className="h-full brand-gradient transition-[transform,background-color,border-color,color,box-shadow,opacity] duration-700 rounded-full"
              ...
              {mix.realRatio != null && (
                <div className="mt-2 flex items-center gap-3 text-[11px] text-muted-foreground" title={t("mixTiltTip")}>
                  ...
                  <div className="h-1.5 w-32 rounded-full overflow-hidden bg-muted/30 flex shrink-0">
                    ...
                    <div className="h-full bg-blue-500/60" style={{ width: `${100 - Math.round(mix.realRatio * 100)}%` }} />
                  </div>
