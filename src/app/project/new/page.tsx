...
export default function NewProjectPage() {
  ...
  const exportSelectedTemplate = () => {
    ...
    a.download = `mora-template-${tpl.name.en.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "") || "recipe"}.json`;
    a.click();
  ...
  const exportMinePack = () => {
    ...
    const a = document.createElement("a");
    a.href = URL.createObjectURL(blob);
    a.download = `mora-template-pack-${myTemplates.length}.json`;
    a.click();
    URL.revokeObjectURL(a.href);
  };
      ...
      <main className="mx-auto max-w-2xl px-6 py-10">
        ...
        {!isLLMConfigured && (
          <Link href="/settings?tab=llm">
            <Notice tone="warning" title={t("llmWarnTitle")} className="mb-6 transition-colors hover:brightness-[.98]">
              {t("llmWarnDesc")} <span className="font-medium underline underline-offset-2">{t("llmWarnCta")}</span>
            </Notice>
          </Link>
        )}
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                {getExampleProducts(locale).map((ex) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-full text-xs border border-border/50 bg-muted/20 text-muted-foreground hover:border-primary/40 hover:text-foreground transition-[transform,background-color,border-color,color,box-shadow,opacity]"
                  >
                    {ex.name} ¥{ex.price}
                  </button>
                ))}
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`relative flex items-center justify-center h-11 rounded-lg border text-sm font-medium transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full border text-xs font-medium transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                ...
                {videoModeOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex items-start gap-3 p-3.5 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                        videoMode === opt.value
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 p-3 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {styleOptions.map((opt) => (
                  <button
                    ...
                    className={`relative flex flex-col items-start p-3.5 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
            ...
            <div>
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1">
                  ...
                  <button
                    ...
                    className={`shrink-0 flex flex-col items-start p-3 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] min-w-[140px] ${
          ...
          <div>
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 mb-3">
                    ...
                    {recommended.map((tpl) => (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-full text-xs border transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
              ...
              <div className="flex flex-wrap items-center gap-1.5 mb-3">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-full text-xs border border-primary/40 bg-primary/5 text-primary hover:border-primary disabled:opacity-40 disabled:cursor-not-allowed transition-[transform,background-color,border-color,color,box-shadow,opacity]"
                >
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-full text-xs border border-border/50 bg-muted/20 text-muted-foreground hover:border-primary/40 transition-[transform,background-color,border-color,color,box-shadow,opacity]"
                >
                ...
                <div className="mb-3 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-1 rounded-full text-xs border border-primary/40 bg-primary/5 text-primary hover:border-primary disabled:opacity-40 transition-[transform,background-color,border-color,color,box-shadow,opacity]"
                    >
                      {t("adTemplateImportConfirm")}
                    </button>
                    <button
                      onClick={() => { setImportOpen(false); setImportText(""); setMineNotice(""); }}
                      className="px-3 py-1 rounded-full text-xs border border-border/50 bg-muted/20 text-muted-foreground hover:border-primary/40 transition-[transform,background-color,border-color,color,box-shadow,opacity]"
                    >
                ...
                <div className="mb-3 p-3 rounded-lg border border-primary/30 bg-primary/[0.03] space-y-3">
                  ...
                  <div className="flex flex-wrap items-end gap-2">
                    ...
                    <Checkbox
                      ...
                      onChange={(e) => setEditorDraft((d) => (d ? { ...d, compose: { ...d.compose, bgmDuck: e.target.checked } } : d))}
                      label={t("adTplComposeDuck")}
                      className="pb-1.5"
                    />
                    <Checkbox
                      checked={editorDraft.compose.productCard ?? false}
                      onChange={(e) => setEditorDraft((d) => (d ? { ...d, compose: { ...d.compose, productCard: e.target.checked } } : d))}
                      label={t("adTplComposeCard")}
                      className="pb-1.5"
                    />
                  </div>
                  <textarea
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-[30rem] overflow-y-auto pb-1 pr-1">
                <button
                  ...
                  className={`flex flex-col items-start p-3 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                  ...
                  myTemplates
                    ...
                    .map((tpl) => (
                      <button
                        key={tpl.id}
                        onClick={() => pickAdTemplate(tpl.id)}
                        className={`relative flex flex-col items-start p-3 rounded-lg border text-left transition-[transform,background-color,border-color,color,box-shadow,opacity] ${
                          selectedAdTemplateId === tpl.id
                            ? "border-primary bg-primary/10"
                            : "border-border/50 bg-muted/20 hover:border-primary/40"
                        }`}
