 ...
 * Fetch product page → parse title/price/description/images → (optionally) persist as a project; the frontend or CLI can then use the projectId to go straight to script → video generation.
 */
